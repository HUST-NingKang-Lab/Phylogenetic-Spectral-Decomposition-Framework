...
DATASET_COLORS = {
    "Palleja": "#7E9FBE",   # muted blue for background clouds
    "Infant": "#9B7A4A",    # muted brown-tan, less yellow
    "IBD": "#BE8A86",       # muted rose-red for background clouds
}
DATASET_MARKERS = {
    "Palleja": "o",
    "Infant": "^",
...
REGION_COLORS = {
    "unstable": "#D7CFD8",   # pale mauve-gray
    "stable": "#CDD9D3",     # pale green-gray
}
...
def plot_host_phase_space(df: pd.DataFrame) -> None:
    ...
    for dataset in ["Palleja", "Infant", "IBD"]:
        ...
        confidence_ellipse(
            ...
            color=dcolor, alpha=0.09, lw=0.9, n_std=1.22, zorder=1
        )
        for _, sub in dsub.groupby("group"):
            ...
            ax.scatter(xj, yj, s=15, marker=marker, c=dcolor, alpha=0.12,
