...
GROUP_COLORS = {
    "Pre-stable": "#5C8FC2",
    "Perturbation": "#8B5FBF",   # purple to avoid duplication with IBD red
    "Recovery": "#55A868",
    "Immature": "#E3A137",
    "Mature": "#B97A18",
    "Healthy": "#2F87B9",        # teal-blue to avoid duplication with Pre-stable
    "IBD": "#C9453B",
}
...
def plot_host_phase_space(df: pd.DataFrame) -> None:
    ...
    for dataset in ["Palleja", "Infant", "IBD"]:
        ...
        for _, sub in dsub.groupby("group"):
            ...
            ax.scatter(xj, yj, s=10, marker=marker, c=dcolor, alpha=0.08,
    ...
    if "Palleja" in cdict:
        ...
        ax.plot([a[0], b[0]], [a[1], b[1]], color=ARROW_COLORS["Palleja"], lw=2.0, alpha=0.45, zorder=24)
        ax.plot([b[0], c[0]], [b[1], c[1]], color=ARROW_COLORS["Palleja"], lw=2.0, alpha=0.45, zorder=24)
        draw_arrow(ax, a, b, color=ARROW_COLORS["Palleja"], lw=2.1, rad=0.24, zorder=27)
        draw_arrow(ax, b, c, color=ARROW_COLORS["Palleja"], lw=2.1, rad=-0.22, zorder=27)
    ...
    if "Infant" in cdict:
        ...
        ax.plot([a[0], b[0]], [a[1], b[1]], color=ARROW_COLORS["Infant"], lw=2.05, alpha=0.52, zorder=24)
        draw_arrow(ax, a, b, color=ARROW_COLORS["Infant"], lw=2.15, rad=0.0, zorder=28)
    ...
    if "IBD" in cdict:
        ...
        ax.plot([a[0], b[0]], [a[1], b[1]], color=ARROW_COLORS["IBD"], lw=2.05, alpha=0.52, zorder=24)
        draw_arrow(ax, a, b, color=ARROW_COLORS["IBD"], lw=2.15, rad=0.0, zorder=29)
    ...
    ax.set_xlim(-0.035, 1.075)
    ax.set_ylim(-0.035, 1.065)
